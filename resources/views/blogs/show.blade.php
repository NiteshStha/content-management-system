...
<!-- Header -->
<header
    class="header text-white h-fullscreen pb-80"
    ...
    <div class="container text-center">
        <div class="row h-100">
            ...
            <div class="col-12 align-self-end text-center">
                <a
                    class="scroll-down-1 scroll-down-white"
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto contents">
                    <p class="text-justify">
                        {!! $post->content !!}
                        <div class="addthis_inline_share_toolbox mt-6"></div>
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/
                    ...
                    (function() { // DON'T EDIT BELOW THIS LINE
                        ...
                        s.src = 'https://saas-blog-i89tkb3ywr.disqus.com/embed.js';
